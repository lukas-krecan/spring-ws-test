...
public class DefaultXmlUtil implements XmlUtil {
	...
	/* (non-Javadoc)
	 * @see net.krecan.springws.test.util.XmlUtil#loadDocument(javax.xml.transform.Source)
	 */
	...
	/* (non-Javadoc)
	 * @see net.krecan.springws.test.util.XmlUtil#loadDocument(org.springframework.core.io.Resource)
	 */
	...
	/* (non-Javadoc)
	 * @see net.krecan.springws.test.util.XmlUtil#transform(javax.xml.transform.Source, javax.xml.transform.Result)
	 */
	...
	/* (non-Javadoc)
	 * @see net.krecan.springws.test.util.XmlUtil#transform(javax.xml.transform.Source, javax.xml.transform.Source, javax.xml.transform.Result)
	 */
	...
	/* (non-Javadoc)
	 * @see net.krecan.springws.test.util.XmlUtil#loadDocument(org.springframework.ws.WebServiceMessage)
	 */
	...
	/* (non-Javadoc)
	 * @see net.krecan.springws.test.util.XmlUtil#getEnvelopeSource(org.springframework.ws.WebServiceMessage)
	 */
	...
	/* (non-Javadoc)
	 * @see net.krecan.springws.test.util.XmlUtil#serializeDocument(javax.xml.transform.Source)
	 */
	...
	/* (non-Javadoc)
	 * @see net.krecan.springws.test.util.XmlUtil#serializeDocument(org.springframework.ws.WebServiceMessage)
	 */
	...
	/* (non-Javadoc)
	 * @see net.krecan.springws.test.util.XmlUtil#serializeDocument(org.w3c.dom.Document)
	 */
